...
if (!isset($_SESSION['login']) || $_SESSION['login'] != 1 || !isset($_SESSION['userId'])) {
    header('location: ../login/login_user.php'); // Jika belum login, arahkan ke halaman login
    exit;
}
    ...
    <div class="container">
        ...
        <div class="pembayaran">
            ...
            <div class="data">
                <div class="nama">
                    <h3>Nama</h3>
                    <p><?php echo isset($info["NAMA_USER"]) ? $info["NAMA_USER"] : 'Tidak Diketahui'; ?></p>
                </div>
                <div class="alamat">
                    <h3>Alamat</h3>
                    <p><?php echo isset($info["ADDRESS"]) ? $info["ADDRESS"] : 'Tidak Diketahui'; ?></p>
                </div>
                <div class="saldo">
                    <h3>Saldo</h3>
                    <p>Rp. <?php echo isset($info["SALDO"]) ? $info["SALDO"] : '0'; ?></p>
                </div>
            </div>
